...
export interface IPaymentMethodsPersistence extends IGetter<PaymentMethodV1, string>, IWriter<PaymentMethodV1, string> {
    ...
    getOneById(correlationId: string, id: string, callback: (err: any, item: PaymentMethodV1) => void): void;
    ...
    deleteById(correlationId: string, id: string, callback: (err: any, item: PaymentMethodV1) => void): void;
}
